...
Хочется именно Boeing, т. е. Airbus тоже было бы классно, если бы была такая опция, в смысле не L-39, например. Ну и чтобы можно было повторить [этот мув](https://youtu.be/B4WkyvNOrW0?t=580), или [этот](https://youtu.be/mPbd3oclDD4?t=651) - как раз оба Boeing 737-500.
